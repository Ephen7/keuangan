<div class="row">
                        ...
                        <form method="POST">
                            <table align="center" style="margin:10px 10px 0px 10px;">
                                <tr>
                                    ...
                                    <td>  <a style="margin:0px 10px 0px 0px;" href="tampil_msk.php" type="button" class="btn btn-success" name="semua" >Semua</a></td> <td> 
                                    <?php 
                                    include 'koneksi.php';
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php 
		include 'koneksi.php';
        $query = mysqli_query($koneksi,"select max(kode) as kode_ FROM kas where jenis ='keluar'");
        ...
        if (isset($_POST['filter'])){
            $dari_tgl = mysqli_real_escape_string($koneksi, $_POST['dari_tgl']);
            $sampai_tgl = mysqli_real_escape_string($koneksi, $_POST['sampai_tgl']);
            $data = mysqli_query($koneksi,"select * from kas where jenis ='keluar' and tgl between '$dari_tgl' and '$sampai_tgl'");
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a id="edit_data" data-toggle="modal" data-target="#edit" data-id="<?php echo $d['kode'] ?>" data-ket="<?php echo $d['keterangan'] ?>" data-tgl="<?php echo $d['tgl'] ?>" data-jml="<?php echo $d['keluar'] ?>" class="btn btn-info"><i class="fa fa-edit"></i>EDIT</a>

					<a onclick="return confirm('Yakin ingin Hapus Data ini?')" href="?page=hapus_keluar&id=<?php echo $d['kode']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i>HAPUS</a>
				</td>
			</tr> 
			<?php 
                        ...
                        <div class="panel-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Form Input Pengeluaran</h4>
                                        </div>
  						...
  						<?php
  							...
  							if (isset($_POST['simpan'])){
  								...
  								$data = mysqli_query($koneksi,"insert into kas (kode, keterangan, tgl, jumlah, jenis, keluar)values('$kode', '$ket', '$tgl', 0, 'keluar', '$jml')");
                            ...
                            <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Form Ubah Pengeluaran</h4>
                                        </div>
                         ...
                         if (isset($_POST['ubah'])){
  								...
  								$data = mysqli_query($koneksi,"update kas set keterangan ='$ket', tgl='$tgl', jumlah =0, jenis ='keluar', keluar='$jml' where kode ='$kode'");
